...
git_cmd <- sprintf("git diff %s..%s .", last_devbranch_commit[["sha"]], to_compare[["sha"]])
...
git_cmd <- sprintf(
  "git diff %s..%s .", last_devbranch_commit[["sha"]], to_compare[["sha"]]
)
result <- system(git_cmd, intern = TRUE)
...
git_cmd <- sprintf(
  "git diff %s..%s . %s", last_devbranch_commit[["sha"]], to_compare[["sha"]], 

---
title: "Getting started with RcppCWB"
...
Throws one warning (if (ch >= 32 & ch < 127))
...
how to merge static libraries:
https://stackoverflow.com/questions/3821916/how-to-merge-two-ar-static-libraries-into-one

```{sh, eval = FALSE}
create libcl-1.a
addlib libcl.a
addlib /usr/lib/gcc/i686-w64-mingw32/4.8/lib/libintl.a
addlib /usr/lib/gcc/i686-w64-mingw32/4.8/lib/libpcre.a
addlib /usr/lib/gcc/i686-w64-mingw32/4.8/lib/libglib-2.0.a
save
end
```
...
Workflow:
get archive libraries
compile libcl.a (make cl)
ar 

...
/* int cl_debug; would conflict with import from globals.h ??*/
extern size_t cl_memory_limit; /* is this necessary* 
/* int cl_memory_limit; would conflict / duplicate import from globals.h ??? */

using namespace Rcpp;

// [[Rcpp::export]]
int get_memory_limit() { 
  return cl_memory_limit;
}


// [[Rcpp::export]]
int set_memory_limit(int megabytes){
